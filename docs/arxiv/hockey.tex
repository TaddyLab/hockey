...
\noindent {\huge \bf Hockey Player Performance via

\noindent Regularized Logistic Regression} 

\vskip .5cm
\noindent
{\it \Large Robert B.~Gramacy, Matt Taddy, and Sen Tian}

\vskip 2cm
A hockey player's plus-minus measures the difference between goals
