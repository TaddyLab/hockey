...
player_beta_df <- read.table("/Users/Sen/Documents/Hockey\ Salary\ Analysis/data/previous/playereffect_goal.txt",
...
########### simple model 1: log(salary) = team + player_beta(goals)
